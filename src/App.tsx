...
function EgnePrompter({ prompts, addPrompt, removePrompt, onCopy }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button type="button" onClick={() => onClose && onClose()} className="absolute top-0 right-0 p-1 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">✖</button>
